...
{
    /// <summary>Checks fee compression without turning cheap items free.</summary>
    [TestCase(0L, 0L)]
    [TestCase(20L, 1L)]
    [TestCase(1000L, 1L)]
    [TestCase(500000L, 500L)]
    [TestCase(9000000L, 9000L)]
    [TestCase(2147483647L, 2147483L)]
    public void SoloPrices(long price, long expected)
    {
        Assert.That(SoloBalance.ScalePrice(price), Is.EqualTo(expected));
    }
