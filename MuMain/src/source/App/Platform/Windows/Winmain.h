...
extern void ApplyFrameTimingConfiguration(bool foreground = true);
extern const Core::Time::EffectiveFramePolicy& GetEffectiveFramePolicy();
extern Core::Time::DisplayRefreshRate GetDisplayRefreshRate();
extern Core::Time::DisplayRefreshRate GetMaximumDisplayRefreshRate();
