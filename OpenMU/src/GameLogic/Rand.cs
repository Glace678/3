...
public static class Rand
{
    ...
    public static bool NextRandomBool(int percent)
    {
        ...
        return IsRandomValueWithinChance(a, percent);
    }
    ...
    public static bool NextRandomBool(int chance, int basis)
    {
        ...
        return IsRandomValueWithinChance(a, chance);
    }
    ...
    /// <summary>
    /// Determines whether a zero-based random value falls within the specified chance.
    /// </summary>
    /// <param name="randomValue">The generated random value.</param>
    /// <param name="chance">The number of successful values.</param>
    /// <returns><see langword="true"/> if the random value is below the chance; otherwise, <see langword="false"/>.</returns>
    internal static bool IsRandomValueWithinChance(int randomValue, int chance)
    {
