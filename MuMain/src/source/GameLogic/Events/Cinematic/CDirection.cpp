...
void CDirection::HeroFallingDownDirection()
{
    ...
    Hero->Object.Gravity += 1.5f * FPS_ANIMATION_FACTOR;
    Hero->Object.Angle[0] -= 2.f * FPS_ANIMATION_FACTOR;
    Hero->Object.m_bActionStart = true;
    Hero->Object.Direction[1] += Hero->Object.Direction[0] * FPS_ANIMATION_FACTOR;
    ...
    Hero->Object.Position[2] -= Hero->Object.Gravity * FPS_ANIMATION_FACTOR;
