...
inputs.instructions+=' Each finding must also include evidence: a short exact contiguous verbatim source substring unique within its file. Copy it exactly, including whitespace; this allows deterministic source location instead of guessing line numbers. Evidence locates a claim but does not prove the claimed defect.';
