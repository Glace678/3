...
export function planOperations(entries,textFiles,operations,readBlob){
  ...
  for(const op of operations){
    ...
    const bytes=decode64(op.content_base64);
