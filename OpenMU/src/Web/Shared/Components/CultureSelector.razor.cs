...
{
    private const string MainlandChineseCultureName = "zh-CN";
    private const string MainlandChineseDisplayName = "简体中文";
    ...
    {
        return culture.Name == MainlandChineseCultureName
            ? MainlandChineseDisplayName
            : culture.NativeName;
    }
