...
void Alpha(OBJECT* o)
{
    ...
    if (o->AlphaEnable)
    {
        ...
        {
            o->Alpha += Core::Time::ScaleLinearStep(0.05f, frameScale);
    ...
    {
        const float blend = Core::Time::ScaleBlendCoefficient(0.1f, frameScale);
        o->Alpha += (o->AlphaTarget - o->Alpha) * blend;
    }
